...
export class ActoresService {
  ...
  getDetailActor (actor){
    ...
    this.url_marvel_detail = 'https://gateway.marvel.com:443/v1/public/characters/${this.actorDetail}?ts=1&apikey=c0d74510a8f3ff8dc8b0c4ad529d0af4&hash=2a5f5dcb325a3d34fb2f3262bd6832c7';
    this.actorDetail =this.url_marvel_detail;
